...
- BOE Business Meeting June 24 2026: District academic performance at 95th percentile statewide while spending at 44th percentile; 100% graduation rate (99th percentile); $30.5M Bond Anticipation Note (one-year note, early financing for the capital program — NOT the $143.6M bond itself) sold at 2.644% interest, better than the 3.25% estimate; budget passed with 75% voter approval, up 14 points, within the tax cap; audit found no material weaknesses or significant deficiencies; Colonial Elementary AC — parents Ashley Mills and Concetta Eudicone (incoming Colonial PTA President) spoke at public comment demanding interim fix; PTAs subsequently funded window units installed September 8 2026; full HVAC conversion Summer 2027 (est. $15M for central air); Siwanoy expansion plans to the State summer 2026, bidding fall 2026, construction spring 2027; AI faculty guidelines rolled out spring 2026, student guidelines fall 2026; phone/digital device ban at the high school had positive climate impact; $1.3M security camera grant being implemented
- Pelham Middle School principal transition: Jennifer Mangone succeeding Lynn Sabia (retiring). NOTE: not stated in any processed meeting record — if asked, say it has been reported and point the resident to pelhamschools.org to confirm
...
- Village of PELHAM MANOR Board of Trustees August 17 2026: Amtrak Forest Road corridor project raised in public comment by resident/volunteer firefighter Josh Casper — flyers delivered to only some affected households, some phases to run 24/7 with track shutdowns, no clear noise threshold or reporting mechanism from Amtrak's rep, litter from past crews, and a rail gate left open; corridor project expected to span 3 years; Village Manager Luft to stay in contact with Amtrak's project liaison, and the board directed increased police patrol sweeps plus deployment of the village's mobile spotlight along the corridor. NOTE: Forest Road/Amtrak is a PELHAM MANOR matter — NOT the Village of Pelham and NOT the Town of Pelham. Direct residents to pelhammanor.gov and the Pelham Manor board, which meets monthly on Mondays at 4 Penfield Place
- Village of Pelham Manor August 17 2026 other business: total fund balance ~$19M at end of July with ~$15M real property taxes in line with budget; FY2025-26 budget amendment approved at net zero cost to taxpayers; special permit renewed for Pelham Parking LLC (bus storage, Canal Road, 3-year term, 3% annual fee increase); new special permit and site plan for Five Canal Road LLC (Mount Vernon bus company maintenance facility) with conditions — maintenance only, right-turn-only truck route, employees park on site, no overnight electric bus storage; New York Athletic Club pool complex reconstruction at 31 Shore Road approved but NO permits until formal DEC approval in hand; ~$5,000 additional from NYS DOT for last winter's snow and ice removal; 66-tree NIPA order bringing calendar-year total to ~81 trees; e-bikes/e-scooters require riders 16+, helmets for 16-17, banned from sidewalks; e-dirt bikes not legal on public roads/paths/parks unless registered and insured
- Receiver of Taxes — STILL VACANT as of September 14 2026 Town Council meeting. Deputy Receiver Darlene Paolericio continues fulfilling all duties. Town Board is considering whether to appoint a replacement OR hold a public referendum to make the position permanently appointed rather than elected. Full discussion scheduled for October 2026 meeting. No appointment was made at the September 14 meeting.
...
- Public meetings: Village of Pelham 2nd & 4th Tuesdays at 200 Fifth Ave; Pelham Manor monthly Mondays at 4 Penfield Place; Town Board monthly at 20 Fifth Ave (Daronco Town House); Town Hall offices are at 34 Fifth Ave; Board of Ed monthly at district offices
